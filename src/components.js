...
export function TodaysTopSport(weather) {
    if (weather.weather[0].main.includes('Clouds') || weather.weather[0].main.includes('Haze') || weather.weather[0].main.includes('Smoke') || weather.weather[0].main.includes('Mist') || weather.weather[0].main.includes('Dust')) {
        ...
        return (
            <div className="sportList">
                <a href="https://www.google.com/search?q=Swimming+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="topSportIcon"
                    src={swim}
                    alt='Icon'
        ...
        return (
            <div className="sportList">
                <a href="https://www.google.com/search?q=skiing+equipment&tbm=shop" target="_blank" rel="noopener noreferrer" ><img className="topSportIcon"
                    src={ski}
                    alt='Icon'
        ...
        return (
            <div className="sportList">
                <a href="https://www.google.com/search?q=Cycling+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="topSportIcon"
                    src={cycle}
                    alt='Icon'
...
export function numberOneSuggested(weather) {
    if (weather.weather[0].main.includes('Clouds') || weather.weather[0].main.includes('Haze') || weather.weather[0].main.includes('Smoke') || weather.weather[0].main.includes('Mist') || weather.weather[0].main.includes('Dust')) {
        ...
        return (<div className="sportList">
            <p className="sportName"><a href="https://www.google.com/search?q=volleyball+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="sportIcon"
                src={volley}
                alt='Icon'
            /></a> Volleyball</p>
        </div>
        ...
        return (<div className="sportList">
            <p className="sportName"><a href="https://www.google.com/search?q=Snowboarding+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="sportIcon"
                src={snowboard}
                alt='Icon'
            /></a> Snowboarding</p>
        </div>
        ...
        return (<div className="sportList">
            <p className="sportName"><a href="https://www.google.com/search?q=indoor+football+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="sportIcon"
                src={football}
                alt='Icon'
            /></a> Indoor Football</p>
        </div>
...
export function numberTwoSuggested(weather) {
    if (weather.weather[0].main.includes('Clouds') || weather.weather[0].main.includes('Haze') || weather.weather[0].main.includes('Smoke') || weather.weather[0].main.includes('Mist') || weather.weather[0].main.includes('Dust')) {
        ...
        return (<div className="sportList">
            <p className="sportName"><a href="https://www.google.com/search?q=football+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="sportIcon"
                src={football}
                alt='Icon'
            /></a> Football</p>
        </div>
        ...
        return (<div className="sportList">
            <p className="sportName"><a href="https://www.google.com/search?q=ice+Skating+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="sportIcon"
                src={skate}
                alt='Icon'
            /></a> Ice Skating</p>
        </div>
        ...
        return (<div className="sportList">
            <p className="sportName"><a href="https://www.google.com/search?q=indoor+volleyball+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="sportIcon"
                src={volley}
                alt='Icon'
...
export function numberThreeSuggested(weather) {
    if (weather.weather[0].main.includes('Clouds') || weather.weather[0].main.includes('Haze') || weather.weather[0].main.includes('Smoke') || weather.weather[0].main.includes('Mist') || weather.weather[0].main.includes('Dust')) {
        ...
        return (<div className="sportList">
            <p className="sportName"><a href="https://www.google.com/search?q=Sledging+equipment&tbm=shop" target="_blank" rel="noopener noreferrer"><img className="sportIcon"
                src={sledge}
                alt='Icon'
            /></a> Sledging</p>
        </div>
